	...
	class Display_Latest_Tweets_Widget extends WP_Widget {
		...
		public function __construct() {
			$widget_options = array(
				...
				'description' => esc_html__( 'A widget that displays your recent tweets from twitter.', 'awesome-latest-tweets' )
			);
			parent::__construct(
				'awesome-latest-tweets',
				esc_html__( 'Awesome Latest Tweets', 'awesome-latest-tweets' ),
				$widget_options
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( ! empty( $tweets ) ) {
				...
				foreach ( $tweets as $tweet ) {
					...
					$human_time = human_time_diff( $created ) . esc_html__( ' ago', 'awesome-latest-tweets' );
					echo '<li class="tweet">';
					echo $text;
				...
				if ( current_user_can( 'manage_options' ) ) {
					esc_html_e( 'Error fetching twitter feeds. Please verify the Twitter settings in the widget.', 'awesome-latest-tweets' );
				}
			}
		...
		public function form( $instance ) {
			$title                     = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Latest Tweets', 'awesome-latest-tweets' );
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>">
					<?php esc_attr_e( 'Title: ', 'awesome-latest-tweets' ); ?>
                </label>
                <input
                        type="text"
                        class="widefat"
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'update_count' ); ?>">
					<?php esc_attr_e( 'Number of Tweets to Display: ', 'awesome-latest-tweets' ); ?>
                </label>
                <input
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'consumer_key' ); ?>">
					<?php esc_attr_e( 'Consumer Key: ', 'awesome-latest-tweets' ); ?>
                </label>
                <input
                        class="widefat"
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'consumer_secret' ); ?>">
					<?php esc_attr_e( 'Consumer Secret: ', 'awesome-latest-tweets' ); ?>
                </label>
                <input
                        type="text"
                        class="widefat"
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'oauth_access_token' ); ?>">
					<?php esc_attr_e( 'Access Token: ', 'awesome-latest-tweets' ); ?>
                </label>
                <input
                        type="text"
                        class="widefat"
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'oauth_access_token_secret' ); ?>">
					<?php esc_attr_e( 'Access Token Secret: ', 'awesome-latest-tweets' ); ?>
                </label>
                <input
                        type="text"
                        class="widefat"
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'twitter_duration' ); ?>">
					<?php esc_attr_e( 'Load new Tweets every: ', 'awesome-latest-tweets' ); ?>
                </label>
		...
		private function twitter_duration() {
			return array(
				'5'    => __( '5 Minutes', 'awesome-latest-tweets' ),
				'15'   => __( '15 Minutes', 'awesome-latest-tweets' ),
				'30'   => __( '30 Minutes', 'awesome-latest-tweets' ),
				'60'   => __( '1 Hour', 'awesome-latest-tweets' ),
				'120'  => __( '2 Hours', 'awesome-latest-tweets' ),
				'240'  => __( '4 Hours', 'awesome-latest-tweets' ),
				'720'  => __( '12 Hours', 'awesome-latest-tweets' ),
				'1440' => __( '24 Hours', 'awesome-latest-tweets' ),
			);
		}
